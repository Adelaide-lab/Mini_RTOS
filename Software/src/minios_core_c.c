...
#include "mini_core_c.h"


U32 guiCurTask;                         /* 当前运行的任务 */

M_TCB* gpstrTask1Tcb;                   /* 任务1的TCB指针 */
M_TCB* gpstrTask2Tcb;                   /* 任务2的TCB指针 */
...
返 回 值: 任务的TCB指针.
***********************************************************************************/
M_TCB* MIN_TaskInit(VFUNC vfFuncPointer, U32* puiTaskStack)
{
    M_TCB* pstrTcb;
